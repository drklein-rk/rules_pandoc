...
some other ruleset that depends on rules_pandoc, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_pandoc=$(pwd)/rules_pandoc"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_pandoc` on your system will point to this folder.
...
https://github.com/drklein-rk/rules_pandoc/actions/workflows/tag.yaml
